  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white via-zinc-50 to-zinc-100 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Heat Map */}
        <div className="rounded-3xl border border-zinc-200 bg-white/70 backdrop-blur-xl p-6 shadow-sm">
          <StrikeZone
            value={null}
            onChange={() => {}}
            pitches={allPitches}
...
function Metric({
  ...
  return (
    <div className="rounded-2xl bg-white/60 border border-zinc-200 p-5 shadow-sm">
